...
from .array_api import get_namespace, _asarray_with_order
...
def _assert_all_finite(
    ...
    # everything is finite; fall back to O(n) space `np.isinf/isnan` and 
    ...
    if has_inf or has_nan_error:
        ...
        if estimator_name and input_name == "X" and has_nan_error:
            # Improve the error message on how to handle missing values
            msg_err += (
...
def check_sample_weight(sample_weight, X, dtype=None, copy=False, only_non_negative=False):
    """
